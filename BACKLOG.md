...
### P2 — 2주 내 (품질 향상)
- 📋 T-121: Vite 코드 스플리팅 설정 (성능 HIGH)
- 📋 T-122: 회원가입 간소화 (UX HIGH)
- 📋 T-123: 부모 대시보드에 자녀 지출 요약 추가 (UX HIGH)
- 📋 T-124: 가족 코드 공유 개선 (UX HIGH)
- 📋 T-125: 접근성 개선 (a11y HIGH)
- 📋 T-126: 서버 에러 응답에서 내부 정보 제거 (보안 HIGH)
